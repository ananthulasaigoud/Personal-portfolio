...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-32 right-32 w-24 h-24 rounded-full bg-gradient-to-r from-accent/20 to-primary/20 animate-float" style={{animationDelay: '1s'}} />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto animate-slide-up">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button 
            size="lg" 
            className="hero-glow animate-glow-pulse bg-gradient-to-r from-primary to-accent hover:shadow-2xl transition-all duration-300"
          ...
          <Button 
            variant="outline" 
            size="lg"
            className="glass-card hover:bg-secondary/20 transition-all duration-300"
